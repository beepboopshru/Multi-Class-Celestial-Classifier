...
def build_model(num_classes):
    ...
    model = models.Sequential([
        ...
        # --- FIX 1: REMOVED THE EXTRA DENSE LAYER ---
        # This is the single, correct output layer for a multi-class model.
        layers.Dense(num_classes, activation='softmax')
    ])
    
    model.compile(optimizer='adam',
                  # --- FIX 2: CHANGED THE LOSS FUNCTION ---
...
if __name__ == '__main__':
    # --- Configuration ---
    # --- FIX 3: UPDATED THE DATA FOLDER AND MODEL SAVE PATH ---
    ...
    # This correctly gets the number of classes (3) from the data folders
    ...
    model_save_path = 'multi_celestial_classifier.keras'
